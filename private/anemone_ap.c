...
anemone_bool does_the_optional_argument_exist(anemone_struct lib,
                                              char *argument_name)
{
    return anemone__search_value_in_optional_argument_list(lib.optional_argument_list, argument_name) != NULL ? ANEMONE_TRUE : ANEMONE_FALSE;
}
